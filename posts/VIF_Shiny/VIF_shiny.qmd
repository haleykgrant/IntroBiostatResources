              ...
              tabPanel("MLR and VIF",
                       sidebarLayout( 
                         ...
                         mainPanel(
                          ...
                          p("Let's imagine splitting the data based on the value (here I rounded to the nearest whole number) of x2. 
                          ...
                          p("Notice how if we picked a non-zero correlation between x1 and x2, the range of values of x1 for any value we fix for x2 is 
                           ...
                           p(),
                          h3("Added Variables Plots"),
                          p("To see how added variables plots are made imagine we \"regress out\" x2 both from x1 and from y. What this means is that we 
                            to remove the effects associated with x2 from both x1 and from y."),
