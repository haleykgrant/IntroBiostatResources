              ...
              tabPanel("MLR and VIF",
                       sidebarLayout( 
                         ...
                         mainPanel(
                          ...
                          fluidRow(
                             column(6, plotOutput("dataPlot3", height = "300px"))
                           ),
                          p("This is essentially what an added variable plot it. "),
...
server <- function(input, output) {
  ...
  output$dataPlot2 <- renderPlot({
    ...
    vals$dt %>% 
      ...
      geom_smooth(method = "lm", se = F, size = 0.5) + 
      labs(color = "x2\n(rounded)")+  
        stat_summary(fun = mean, geom = "vline", aes(xintercept = ..x..), color = "black", linetype = "dashed") +
  stat_summary(fun = mean, geom = "hline", aes(yintercept = ..y..), color = "black",  linetype = "dashed")
  })
