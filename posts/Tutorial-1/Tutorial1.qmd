...
This tutorial is was developed based on [this resource](https://github.com/rstudio/learnr/tree/main/inst/tutorials/ex-setup-r/ex-setup-r.Rmd). The goal is to make sure you have R, Rstudio, and an R package called the `tidyverse` installed on your computer.
