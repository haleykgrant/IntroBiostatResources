...
Each code chunk has a <span style="padding: 3px; position: relative;margin-right: 6px;">
  <i style="font-size: 12px; position: absolute; top: 8px; left: 4px;" class="fa">&#xf021;</i>
  <span style="margin-left: 10px;"> </span>
</span> button in the upper right corner that allows you to reset the code.If you make a mistake and want to start from scratch, hit this button! 
