...
[Error: non-numeric argument to binary operator]{style="color: #BB0000; font-family: 'Courier New'; font-weight: 500;"}
:::
...
::: {style="text-align: center;"}
[`function_name(argument1 , argument2 , ...)`]{style="font-family: 'Courier New';"}
:::
...
:::: {style="text-align: center;"}
[library(mypackage)]{style="font-family: 'Courier New'; font-weight: 500;"}
::::

and get an error message like this:

:::: {style="text-align: center;"}
[Error in library(mypackage) : there is no package called ‘mypackage’]{style="color: #BB0000; font-family: 'Courier New'; font-weight: 500;"}
::::
...
::: {style="text-align: center;"}
[Error: could not find function "tidyverse_packages"]{style="color: #BB0000; font-family: 'Courier New'; font-weight: 500;"}
:::
